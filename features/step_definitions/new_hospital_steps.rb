...
Quando("eu adiciono as informações {string} e {string} e {string} e {string} e {string} e {string} e {string} e {string} e {string} e {string} e {string}") do 
|hosp_name, hosp_city, hosp_state, a_plus, a_minus, b_plus, b_minus, o_plus, o_minus, ab_plus, ab_minus|
